...
public class ThriftServerDefBuilder {
	...
	public ThriftServerDef build() {
		...
		return new ThriftServerDef(name, serverPort, maxFrameSize, queuedResponseLimit, processorFactory, inProtocolFact, outProtocolFact, useHeaderTransport, executor);
	}
}
